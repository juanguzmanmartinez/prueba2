...
then
    ...
    sed -i -e 's/https:\/\/4kz2r4t838.execute-api.us-east-1.amazonaws.com\/CI02/https:\/\/fduetuxpf0.execute-api.us-east-1.amazonaws.com\/DEV/g' /usr/share/nginx/html/main*.js
    sed -i -e 's/https:\/\/28c9y4dvs8.execute-api.us-east-1.amazonaws.com\/CI02/https:\/\/vsfpgmkkvf.execute-api.us-east-1.amazonaws.com\/DEV/g' /usr/share/nginx/html/main*.js
...
then
    ...
    sed -i -e 's/https:\/\/4kz2r4t838.execute-api.us-east-1.amazonaws.com\/CI02/https:\/\/fduetuxpf0.execute-api.us-east-1.amazonaws.com\/QAS/g' /usr/share/nginx/html/main*.js
    sed -i -e 's/https:\/\/28c9y4dvs8.execute-api.us-east-1.amazonaws.com\/CI02/https:\/\/vsfpgmkkvf.execute-api.us-east-1.amazonaws.com\/QAS/g' /usr/share/nginx/html/main*.js
    sed -i -e 's/authPassword:"12345"/authPassword:"ypej47Qm14QhjB93Sf"/g' /usr/share/nginx/html/main*.js
