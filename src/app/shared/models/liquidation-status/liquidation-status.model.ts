...
export const CLiquidationStatusTranslation = {
  ...
  [ELiquidationStatus.charged]: 'Orden cobrada correctamente',
  ...
  [ELiquidationStatus.pendingLiquidation]: 'Pendiente para Liquidación',
  [ELiquidationStatus.pendingRefund]: 'Pendiente de anular',
  [ELiquidationStatus.refunded]: 'Orden anulada correctamente',
