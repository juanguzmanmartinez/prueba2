...
export class LocalClientService {
  ...
  private readonly LOCAL = ENDPOINTS.GET_DRUGSTORE;
  private readonly LOCAL_BY_SERVICE_TYPE_ENDPOINT = ENDPOINTS.GET_DRUGSTORE_BY_SERVICE_TYPE;
  private readonly TYPE_SERVICE_ENDPOINT = ENDPOINTS.GET_CALENDAR_SERVICE_TYPE;
