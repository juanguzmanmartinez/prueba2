...
export class DrugstoreServiceTypeControlName {
  static state = 'state';
...
@Injectable()
export class OpDrugstoresEditionServiceTypeDetailFormCardFormService implements OnDestroy {
  ...
  private _controlNameList = DrugstoreServiceTypeControlName;
