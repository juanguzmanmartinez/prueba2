...
export class OperationsDrugstoresEditionServiceTypeComponent implements OnInit, OnDestroy {
  ...
  putServiceType(iDrugstoreServiceTypeUpdate: IDrugstoreServiceTypeUpdate): void {
  ...
  saveEdition(iDrugstoreServiceTypeUpdate: IDrugstoreServiceTypeUpdate): void {
  ...
  private setDrugstoreServiceType(): void {
