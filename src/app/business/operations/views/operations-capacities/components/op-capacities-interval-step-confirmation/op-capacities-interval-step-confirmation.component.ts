...
@Component({
  selector: 'app-op-capacities-interval-step-confirmation',
  templateUrl: './op-capacities-interval-step-confirmation.component.html',
  styleUrls: ['./op-capacities-interval-step-confirmation.component.sass'],
})
export class OpCapacitiesIntervalStepConfirmationComponent implements OnInit {
