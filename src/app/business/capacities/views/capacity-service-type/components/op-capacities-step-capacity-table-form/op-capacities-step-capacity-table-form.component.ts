...
export class OpCapacitiesStepCapacityTableFormComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    const subscription = this._opCapacitiesStepCapacityTableForm.capacitySegmentList.valueChanges
      .subscribe(() => {
        this.updateView();
