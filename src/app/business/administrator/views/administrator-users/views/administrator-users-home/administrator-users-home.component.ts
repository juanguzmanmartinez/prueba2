...
export class AdministratorUsersHomeComponent implements OnInit {
  ...
  public displayedColumns: string[] = [
    ColumnNameList.id,
    ColumnNameList.name,
    ColumnNameList.lastname,
    ColumnNameList.position,
    ColumnNameList.role,
  ...
  getUserList() {
    this._administratorUsersImplement.userList.subscribe(
  ...
  settingDataSource() {
    ...
    this.dataSource.filterPredicate = (
      ...
      const roleNormalize = normalizeValue(
        data.permissionList
          .map((permission) => this.roleName[permission.role])
          .join('')
      );
