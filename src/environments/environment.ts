...
export const environment = {
  ...
  // api_gateway_order:
  //   'https://4kz2r4t838.execute-api.us-east-1.amazonaws.com/UAT',
  // api_gateway_auth:
  //   'https://28c9y4dvs8.execute-api.us-east-1.amazonaws.com/UAT',
  // authUsername: 'adm-operations',
  ...
  api_gateway_order:
    'https://4kz2r4t838.execute-api.us-east-1.amazonaws.com/QA02',
  api_gateway_auth:
    'https://28c9y4dvs8.execute-api.us-east-1.amazonaws.com/QA02',
  authUsername: 'adm-operations',
